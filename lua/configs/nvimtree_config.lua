require("nvim-tree").setup({
  ...
  hijack_unnamed_buffer_when_opening = true,                               -- Не перехватывать неименованный буфер при открытии
  ...
  update_focused_file = {
    ...
    update_root = true,                                                    -- Не обновлять корневую директорию
  },
  view = {
  ...
  renderer = {
    ...
    indent_markers = {
      enable = false, -- Включить отображение маркеров отступов
    },
